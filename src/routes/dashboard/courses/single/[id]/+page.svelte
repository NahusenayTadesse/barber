<script lang="ts">
	...
	let singleTable = $derived([
		...
		{ name: 'Level', value: data.product?.level },
		{ name: 'Duration', value: data.product?.duration },
		{ name: 'Base Price', value: data.product?.basePrice },
...
<SingleView title={data?.product?.name} class="w-full!">
